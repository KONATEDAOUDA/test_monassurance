                              ...
                              <div id="rootwizard" class="tab-container tab-wizard">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane" id="tab2">
                                              ...
                                              <div id="formulae_section">
                                                ...
                                                <div class="col-md-12 text-center" style="margin-bottom:15px; margin-top:15px">
                                                    <div class="radio radio-primary radio-inline">
                                                      <input type="radio" style="display: none" id="formuletype" value="F" name="souscription" checked>
                                                    </div>
                                                </div>
                                         ...
                                         <p>
                                            <strong>-La responsabilité civile : </strong>Elle ne couvre que les dommages matériels et corporels causés aux tiers, en cas d’accident dont vous êtes responsable. Elle ne couvre pas ceux que vous-même et votre véhicule subissez.</p>
                                          </p>
...
<script src="{{ asset('back/assets/js/vendor/parsley/parsley.min.js') }}"></script>
<script src=" {{ asset('back/assets/js/vendor/form-wizard/jquery.bootstrap.wizard.min.js') }}"></script>
...
@section('custom-script')
    ...
    $(document).ready(function(){
      ...
      $("#phone").inputmask("99 99 99 99 99",{ "placeholder": "** ** ** ** **","alias": "phone" });
      $("#phone_souscr").inputmask("99 99 99 99 99",{ "placeholder": "** ** ** ** **","alias": "phone" });
    });
