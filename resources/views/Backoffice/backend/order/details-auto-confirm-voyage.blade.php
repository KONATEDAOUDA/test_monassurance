...
<div style="font-size:1.2em;font-weight:bold" class="text-center">VOTRE PROPOSITION</div>
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <div class="row" style="margin-bottom:25px">
        ...
        <button type="button"  data-toggle="modal" data-text="Confirmer la commande" data-target="#confirmModal" style="background-color:#4cae4c;" class="btn btn-primary get-in-touch"> <i class="fa fa-check"></i> Confirmer la commande</button>
        </div>
        @endif
    </div>
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
	    <div class="row">
	      ...
	      <div class="col-md-6">
	        <div class="form">
	          <form  method="post" action="{{route('admin.confirm.auto.quotation')}}">
	          {{csrf_field()}}
	          	<div id="msg"></div>
	            ...
	            <input type="hidden" class="my-textarea" rows="5" required name="delivery_location" value="{{$prospect->contact}}" >
