                        ...
                        <table class="table table-custom" id="advanced-usage">
                            ...
                            <tr>
                              ...
                              {!! get_commande_status($commande->status) !!}
								...
								<td>
                                    {{-- <a class="btn btn-danger del" id="{{route('devis.remove',$commande->qid)}}" data-toggle="modal" data-target="#myModal" href="#"> <i class="glyphicon glyphicon-remove"></i></a> --}}
							
								     	

                                     @if($commande->product_type==1)
                                         
                                         <a href="{{route('devis.details',['id'=>$commande->id,'aid'=>$commande->assurance_infos_id])}}" class="btn btn-success"> <i class="glyphicon glyphicon-edit"></i></a>
                                     @elseif($commande->product_type==3)
                                         <a href="{{route('devis.voyage.details',['id'=>$commande->id,'aid'=>$commande->assurance_infos_id])}}" class="btn btn-success"> <i class="glyphicon glyphicon-edit"></i></a>
                                     @endif									
								</td>
							</tr>
							@endforeach				  									  
