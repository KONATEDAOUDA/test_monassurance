  ...
  <table border="0" cellspacing="0" cellpadding="0">
    ...
    <div class="row" style="margin-bottom:25px">
        <div class="col-md-12 text-center">
            @if($prospect->status==0)
            <button type="button"  data-toggle="modal" data-text="Confirmer la commande" data-target="#confirmModal" style="background-color:#4cae4c;" class="btn btn-primary get-in-touch"> <i class="fa fa-check"></i>
	      ...
	      <div class="col-md-6">
	        <div class="form">
	          ...
	          {{csrf_field()}}
	            ...
	            <input type="hidden" class="my-textarea" rows="5" value="{{$prospect->contact}}" name="delivery_location">
