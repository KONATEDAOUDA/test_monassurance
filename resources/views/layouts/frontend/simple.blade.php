...
<head>
	...
	<meta name="keywords" content="assurance,automobile,moto,voyage,habitation,côte d'ivoire, courtier, courtage,digitale, nsia,serenity,atlas,loyale,atlantique,sonam">
...
<body class="fixed-header">
	...
	<!-- The Main Wrapper -->
		...
		<a style="display: none" href="#." data-toggle="modal" data-target="#call-me" class="btn btn-primary floating" data-text="&nbsp;&nbsp;&nbsp;&nbsp;Je veux me faire appeler"><i class="icon-telephone114"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Besoin d'aide ?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
		<!-- Footer -->
		<footer id="footer">


			@include('layouts.frontend.partials.footer-simple')
		...
		_videodesk['cart_id'] = '' ;
		_videodesk['cart_url'] = '' ;
		_videodesk['uid'] = 'd2d40aa9817f8369a5baa8d902a2caf0' ;
		_videodesk['lang'] = 'fr' ;
		(function() {
